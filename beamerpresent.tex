...
\author{Solon Karapanagiotis \\ \vspace{0.5cm} \text{karapanagiotissolon@gmail.com}\vspace{0.7cm} \text{https://github.com/karapa/Beamer.git}}
\date{\today}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item body contains sections and subsections, the different slides (called \alert{frames}).
		\pause
